...
@section('content')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="text-center">
                                        <div class="mb-4">
                                            <span
                                                class="avatar avatar-xl avatar-rounded border border-3 border-white shadow-lg"
                                        ...
                                        <div class="mb-4">
                                            <span
                                                class="badge bg-{{ $user->status === 'active' ? 'success' : ($user->status === 'inactive' ? 'warning' : 'danger') }} badge-pill fs-6 px-3 py-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-sm me-1" width="24"
                                ...
                                <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label text-muted small fw-medium">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-sm me-1"
                                                        ...
                                                        <path
                                                            d="M16 8v5a3 3 0 0 0 6 0v-5a4 4 0 0 0 -4 -4h-4a4 4 0 0 0 -4 4v5a3 3 0 0 0 6 0v-5" />
                                                    </svg>
                                                    Email Address
                                                </label>
                                    ...
                                    <div class="row mb-4">
                                     ...
                                     <div class="row mb-4">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-label text-muted small fw-medium">Adress</label>
                                                <div class="fw-medium">{{ $user->address }}</div>
                                            </div>
                                        </div>                                        
                                    </div>
                                    ...
                                    <a href="{{ route('users.export.csv') }}" class="btn btn-outline-primary">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon me-1" width="24" height="24"
                                            ...
                                            <path
                                                d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h6l6 6v10a2 2 0 0 1 -2 2z" />
                                            <path d="M12 17v-6" />
    ...
    @if($userBirthday === $today)
        <div id="birthday-wish"
            style="position: fixed; top: 1rem; right: 1rem; z-index: 1050; background: #d4edda; border: 1px solid #c3e6cb; padding: 1rem 1.5rem; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); max-width: 300px; font-weight: 600;">
            🎂 Happy Birthday, {{ $user->first_name }}!<br>
            May your year be filled with happiness and success.
            <button onclick="document.getElementById('birthday-wish').remove()"
                style="border:none; background:none; font-weight:bold; cursor:pointer; float:right;">&times;</button>
        </div>
